...
export const STYLE_APP_BAR__BUTTON_ICON: CSSProperties = {
  height: STYLE_APP_BAR_HEIGHT - 10,
  width: STYLE_APP_BAR_HEIGHT - 10,
}

export const STYLE_APP_BAR__CONTENT: CSSProperties = {
  display: 'flex',
  flexFlow: 'column nowrap',
}

export const STYLE_APP_BAR__TEXT_FIELD_INPUT: CSSProperties = {
...
export const STYLE_APP_BAR__ICON: CSSProperties = {
  padding: 10,
